...
When using the entire dataset, the clusters maintain the same number of data points (as can be seen from the comparison of cluster centers with species tables), so the classification error remains unchanged.
